...
import { MinusProductModalUpdateQuantity } from './product';
...
export const MinusProductModalViewUpdateQuantity = (props: Xprox) => {
            ...
            <Form {...freebiesFormUpdateQuantity}>
              ...
              <Stepper
                    ...
                    <div className='stepperSubDiv'>
                        <MinusProductModalUpdateQuantity productId={props.productId} productOriginalQuantity={props.productOriginalQuantity} productCurrentQuantity={props.productCurrentQuantity} />
                    </div>
                    </Stepper>
              </form>
            </Form>
