...
import { UpdateHomeImagesRequest } from '../../../../../../service/home-images/schema';
...
export const UImagesModal = (props: ImageProps) => {
    const homeImagesFormUpdate = useFormContext<UpdateHomeImagesRequest>()
    ...
    const [imagePreviews, setImagePreviews] = useAtom(homeImagesPreviewUpdateAtom);
    const [propsImg, setPropsImg] = useState(props.homeImg.replace(/\\/g, '').replace(/"/g, '').replace(/\[/g, '').replace(/\]/g, '').split(','));
      ...
      <div className='mt-6 row flex flex-col gap-6'>
        <div className='flex flex-col gap-2 w-full'>
          ...
          <IoMdCloudDownload className='w-16 h-16' />
            ...
            <FormField
                    control={homeImagesFormUpdate.control}
                    name='homeImg'
