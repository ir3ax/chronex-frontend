...
import { generateTotalExpenses } from '../../../../../service/generate-report';
...
export const ModalTotalExpensesView = (props: Xprox) => {
    ...
    const handleSubmit = () => {
        generateTotalExpenses(month, year);
        notify();
        props.handleClose();
    }
                ...
                <form className='w-full h-full'>
                  <div className='w-full h-full flex flex-col justify-center items-start'>
                    <div className='w-full flex flex-col justify-center items-center gap-6 p-12'>
                      <FcMoneyTransfer className='w-24 h-24 text-[#172539]' />
